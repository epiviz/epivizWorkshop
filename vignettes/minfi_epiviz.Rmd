...
settings <- list(lineThickness = 2, step=1)

beta_track <- epivizChart(cpg_gr, datasource_name="Percent Methylation", type="bp", parent=epivizEnv, colors=colors, settings=settings)
...
```{r}
# create annavigation element
# epivizNav <- epivizNav("chr11", 119819400, 120100000, parent=epivizEnv)
...
epivizEnv$init_region(chr="chr11", start=119819400, end=120150600)
