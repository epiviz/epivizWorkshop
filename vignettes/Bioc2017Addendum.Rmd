...
We have a new element called environment. The epiviz-environment enables brushing across all the charts in your current workspace. The environment also lets you set a genomic location to all its children charts. This will be more clear at the end of this vignette.. First, Create an epiviz enivornment
```{r}
epivizEnv <- EpivizEnvironment(chr="chr11", start= 34000000, end = 39000000)
...
Finally lets print all the charts together.
```{r}
epivizEnv
```
